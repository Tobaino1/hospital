...
$connection = mysqli_connect("localhost", "id11975224_tobaino", "jesusislord1", "id11975224_hospital_db");
    ...
    function login($email_id_unsafe, $password_unsafe, $table = 'users')
    {
        ...
        $num_rows = (int) $result->fetch_array();
    ...
    function status($type, $data = 0)
    {
        ...
        switch ($type) {
            ...
            case 'appointment-success':
                return "$success Please note: Your appointment no is $data , Your appointment is booked successfully! You will be notified via Email / Text for the precise day(s). $end";
                break;
