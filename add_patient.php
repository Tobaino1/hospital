...
<!--   <h2>Welcome, <?php echo $_SESSION["fullname"];?>!</h2>
 ...
 <div class='alert alert-info'>
    ...
    <div align="center">
        <h2 style="color: blue"> Appointment Page</h2>
        <h3>Welcome User! Enter Information to book an appointment </h3>
                ...
                ?>
        <table border="2" class="table-bordered" width="500" style="color:blue;">
            <tbody>
            <th>
                <br>
                <form action="add_patient.php" method="POST">
                    ...
                    <div class="form-group" >
                        ...
                        <input type="text" class="form-control" id="usr" name="apfullname" size="50" required>
                    </div>
<br>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-control" id="pwd" size="40" name="apweight" min="1" max="300"
                               required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-control" id="pwd" size="45" name="apphone_no" required>
                    </div>

                    <br>
                    <div class="form-group">
                        <label for="pwd">Address:</label>
                        <textarea class="form-control" cols="50" id="pwd" name="apaddress" required></textarea>
                    </div>
<br>
                    <div class="form-group">
